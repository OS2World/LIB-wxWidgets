...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\foldtest.exe

$(OBJS)\foldtest.exe :  $(FOLDTEST_OBJECTS)
...
$(OBJS)\foldtest_foldpanelbartest.obj :  .AUTODEPEND .\foldpanelbartest.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(FOLDTEST_CXXFLAGS) $<
