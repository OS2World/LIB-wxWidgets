...
$(OBJS)\life.exe :  $(LIFE_OBJECTS)
	@%create $(OBJS)\life.lbc
	@%append $(OBJS)\life.lbc option quiet
	@%append $(OBJS)\life.lbc name $^@
	@%append $(OBJS)\life.lbc option caseexact
	@%append $(OBJS)\life.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(LIFE_OBJECTS)) do @%append $(OBJS)\life.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\life.lbc library %i
	@%append $(OBJS)\life.lbc
...
$(OBJS)\life_life.obj :  .AUTODEPEND .\life.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(LIFE_CXXFLAGS) $<
