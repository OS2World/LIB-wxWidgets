...
$(OBJS)\wxpoem.exe :  $(WXPOEM_OBJECTS)
	...
	@%append $(OBJS)\wxpoem.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(WXPOEM_OBJECTS)) do @%append $(OBJS)\wxpoem.lbc file %i
	@for %i in ( $(__WXLIB_HTML_p)  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\wxpoem.lbc library %i
	@%append $(OBJS)\wxpoem.lbc
...
$(OBJS)\wxpoem_wxpoem.obj :  .AUTODEPEND .\wxpoem.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(WXPOEM_CXXFLAGS) $<
