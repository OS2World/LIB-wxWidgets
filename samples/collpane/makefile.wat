...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\collpane.exe

$(OBJS)\collpane.exe :  $(COLLPANE_OBJECTS)
	...
	@%append $(OBJS)\collpane.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(COLLPANE_OBJECTS)) do @%append $(OBJS)\collpane.lbc file %i
	@for %i in ( $(__WXLIB_ADV_p)  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\collpane.lbc library %i
	@%append $(OBJS)\collpane.lbc
...
$(OBJS)\collpane_collpane.obj :  .AUTODEPEND .\collpane.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(COLLPANE_CXXFLAGS) $<
