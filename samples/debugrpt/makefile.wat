...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\debugrpt.exe

$(OBJS)\debugrpt.exe :  $(DEBUGRPT_OBJECTS)
	...
	@%append $(OBJS)\debugrpt.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(DEBUGRPT_OBJECTS)) do @%append $(OBJS)\debugrpt.lbc file %i
	@for %i in ( $(__WXLIB_QA_p)  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_XML_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\debugrpt.lbc library %i
	@%append $(OBJS)\debugrpt.lbc
...
$(OBJS)\debugrpt_debugrpt.obj :  .AUTODEPEND .\debugrpt.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(DEBUGRPT_CXXFLAGS) $<
