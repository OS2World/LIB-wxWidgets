...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\htmlhelp.exe

$(OBJS)\htmlhelp.exe :  $(HTMLHELP_OBJECTS)
	...
	@%append $(OBJS)\htmlhelp.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(HTMLHELP_OBJECTS)) do @%append $(OBJS)\htmlhelp.lbc file %i
	@for %i in ( $(__WXLIB_HTML_p)  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\htmlhelp.lbc library %i
	@%append $(OBJS)\htmlhelp.lbc
...
$(OBJS)\htmlhelp_help.obj :  .AUTODEPEND .\help.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(HTMLHELP_CXXFLAGS) $<
