...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\listctrl.exe

$(OBJS)\listctrl.exe :  $(LISTCTRL_OBJECTS)
	...
	@%append $(OBJS)\listctrl.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(LISTCTRL_OBJECTS)) do @%append $(OBJS)\listctrl.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\listctrl.lbc library %i
	@%append $(OBJS)\listctrl.lbc
...
$(OBJS)\listctrl_listtest.obj :  .AUTODEPEND .\listtest.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(LISTCTRL_CXXFLAGS) $<
