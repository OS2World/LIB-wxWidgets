...
$(OBJS)\shaped.exe :  $(SHAPED_OBJECTS)
	...
	@%append $(OBJS)\shaped.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(SHAPED_OBJECTS)) do @%append $(OBJS)\shaped.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\shaped.lbc library %i
	@%append $(OBJS)\shaped.lbc
...
$(OBJS)\shaped_shaped.obj :  .AUTODEPEND .\shaped.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(SHAPED_CXXFLAGS) $<
