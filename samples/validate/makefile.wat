...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\validate.exe

$(OBJS)\validate.exe :  $(VALIDATE_OBJECTS)
	...
	@%append $(OBJS)\validate.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(VALIDATE_OBJECTS)) do @%append $(OBJS)\validate.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\validate.lbc library %i
	@%append $(OBJS)\validate.lbc
...
$(OBJS)\validate_validate.obj :  .AUTODEPEND .\validate.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(VALIDATE_CXXFLAGS) $<
